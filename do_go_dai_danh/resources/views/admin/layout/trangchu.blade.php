          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-8">
                  <p class="text-center">
                    <strong>Tổng doanh thu: <span class="progress-number">{{$total_monney}} đồng</span></strong>
                  </p>
              ...
              <div class="row">
                <div class="col-sm-3 col-xs-6">
                  <div class="description-block border-right">
                    ...
                    <h5 class="description-header">{{$total_monney}} đồng</h5>
                ...
                <div class="col-sm-3 col-xs-6">
                  <div class="description-block">
                    ...
                    <span class="description-text">Mục tiêu mỗi ngày</span>
                  </div>
                  <!-- /.description-block -->
                </div>
              </div>
