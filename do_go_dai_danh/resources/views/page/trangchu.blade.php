	...
	<div class="section section-grey">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="banner banner-1">
						<img src="source/image/slide/bannerthang.png" alt="">
						<div class="banner-caption text-center">
							<h1 class="primary-color">HOT DEAL<br><span class="white-color font-weak">Up to 50% OFF</span></h1>
							<a href="http://localhost/do_go_dai_danh/public/san-pham-giam-gia"><button class="primary-btn">Shop Now</button></a>
						</div>
					</div>
				</div>
				<!-- /banner -->
				...
				<div class="col-md-4 col-sm-6">
					<a class="banner banner-1" href="http://localhost/do_go_dai_danh/public/san-pham-moi">
						<img src="source/image/slide/new_collection.jpg" alt="">
						<div class="banner-caption text-center">
