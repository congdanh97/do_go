...
<!-- BREADCRUMB -->
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="http://localhost/do_go_dai_danh/public/index">Home</a></li>
				<li class="active"><a href="http://localhost/do_go_dai_danh/public/dang-nhap">ĐĂNG NHẬP TÀI KHOẢN</a></li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
